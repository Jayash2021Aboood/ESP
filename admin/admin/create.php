<?php
  ...
  include_once( DIR_APPLICATION . 'includes/admin.php');
  checkAdminSession();


  
  $pageTitle = "Add Admin";
  include( DIR_APPLICATION . 'template/header.php'); 
  $errors = array();
...
<?php include( DIR_APPLICATION . 'template/startNavbar.php'); ?>
...
<?php include( DIR_APPLICATION . 'template/footer.php'); ?>