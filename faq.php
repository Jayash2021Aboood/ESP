...
<main>
    ...
    <div class="container-xl px-4">
        ...
        <a class="card card-icon lift lift-sm mb-4" href="faq_category.php">
            <div class="row g-0">
        ...
        <div class="row">
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="faq_category.php">
                    <div class="card-body">
                        <h5 class="card-title text-primary mb-2">
                            <i class="me-2" data-feather="edit-2"></i>
                            Brand Guidelines
                        </h5>
                        <p class="card-text mb-1">Information about what you can and can't do when using our logos and
                            other assets</p>
                    </div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="faq_category.php">
                    <div class="card-body">
                        ...
                        <p class="card-text mb-1">App integration policies and related content on connecting to our
                            database</p>
                    </div>
                    <div class="card-footer">
                        <div class="small text-muted">5 articles in this category</div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="faq_category.php">
                    <div class="card-body">
                        ...
                        <p class="card-text mb-1">Our privacy policy and information on how we track and utilize user
                            data</p>
                    </div>
                    <div class="card-footer">
                        <div class="small text-muted">2 articles in this category</div>
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card lift lift-sm h-100" href="faq_category.php">
                    <div class="card-body">
                        ...
                        <p class="card-text mb-1">Other troubleshooting, help, and support articles related to our
