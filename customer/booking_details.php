            ...
            <div class="card border-start-lg border-start-primary card-header-actions card-scrollable">
                <div class="card-header border-bottom ">
                    <ul class="nav nav-tabs card-header-tabs" id="cardTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="attachments-tab" href="#attachments" data-bs-toggle="tab" role="tab"
                ...
                <div class="card-body p-5">
                    <div class="tab-content" id="cardTabContent">
                        ...
                        <div class="tab-pane fade h-100" id="attachments" role="tabpanel"
                            ...
                            <div class="col-12 noteMessage">
                                <?php 
                                    $allAttachments = getAllBookingNote($row['id']);
                                    if(count($allAttachments ) > 0)
                                    {
                                        foreach($allAttachments as $note)
                                        {                                    
                                ?>
                                <?php if(isCustomer() && $note['customer_id'] == $_SESSION['userID']){ ?>
                                <div>
