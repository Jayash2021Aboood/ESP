            ...
            <nav class="sidenav shadow-right sidenav-light">
                <div class="sidenav-menu">
                    <div class="nav accordion" id="accordionSidenav">
                        ...
                        <a class="nav-link" href="<?php echo $PATH_ADMIN_AUTHER; ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            Auther
                        </a>
                        ...
                        <a class="nav-link" href="<?php echo $PATH_ADMIN_BORROWER; ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            Borrower
                        </a>
                        <a class="nav-link" href="<?php echo $PATH_ADMIN_BORROWER_TYPE; ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            Borrower Type
                        </a>
                        <a class="nav-link" href="<?php echo $PATH_ADMIN_CATEGORY; ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            Category
                        </a>
                        ...
                        <a class="nav-link" href="<?php echo $PATH_ADMIN_JOBHOLDER; ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            Jobholder
                        </a>
                        ...
                        <a class="nav-link" href="<?php echo $PATH_ADMIN_PROJECT; ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            Project
                        </a>
                        ...
                        <a class="nav-link" href="<?php echo $PATH_ADMIN_RESERVATION; ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            Reservation
                        </a>
                        ...
                        <a class="nav-link" href="<?php echo $PATH_ADMIN_UNIVERSITY; ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            University
                        </a>
                        <a class="nav-link" href="<?php echo $PATH_ADMIN_UNIVERSITY_COLLEGE; ?>">
                            <div class="nav-link-icon"><i data-feather="bar-chart"></i></div>
                            University College
                        </a>
